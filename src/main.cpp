...
// coinvest, 구분자
const string strMessageMagic = "HitCoin Signed Message:\n";
...
int64_t GetProofOfWorkReward(int64_t nFees)
{
    ...
    {   // coinvest, 43800블럭 이하 채굴량
        nSubsidy = 479452.0548 * COIN;
        return nSubsidy;
    }
    else
	{
		nSubsidy = (10.0 - (((int)((pindexBest->nHeight+1-43800)/21600))*0.02)) * COIN;
...
bool CheckDiskSpace(uint64_t nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "HitCoin", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        const char* pszTimestamp = "Wed, 02 Mar 2016 05:41:14 +0000";
        CTransaction txNew;
        // coinvest, 최초 시작 시간
        txNew.nTime = 1456897274;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.nVersion = 1;
        // coinvest, 최초 시작 시간
        block.nTime    = 1456897274;
        block.nBits    = bnProofOfWorkLimit.GetCompact();
        // coinvest, nNonce
        block.nNonce   = 5178739;
		if(fTestNet)
        {
        ...
        //// debug print
        // coinvest, MerkleRoot
        assert(block.hashMerkleRoot == uint256("0xfa708964d25f371e69d7f0acf82e5a7179d2bd0cbba880a50f2d07e92f34390f"));
        block.print();
...
// coinvest, 메세지 스타트
unsigned char pchMessageStart[4] = { 0x48, 0x69, 0x74, 0x43 };
